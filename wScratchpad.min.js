...
function newFunction() 
{
    return !function(a) {
        ...
        b.prototype = {
            _generate: function() {
                return a.support.canvas ? (this.canvas = document.createElement("canvas"),
                ...
                this.$scratchpad.mousedown(a.proxy(function(b) {
                    return this.enabled ? (this.canvasOffset = a(this.canvas).offset(),
                    this.scratch = !0,
                    void this._scratchFunc(b, "Down")) : !0;
                ...
                this.init = !0,
                void this.reset()) : (this.$el.append("Canvas is not supported in this browser."),
                !0);
            },
            reset: function() {
                var b = this
                ...
                this.pixels = c * e * d * e,
                this.$img.hide(),
                this.options.bg && ("#" === this.options.bg.charAt(0) ? this.$el.css("backgroundColor", this.options.bg) : (this.$el.css("backgroundColor", ""),
            ...
            _scratchPercent: function() {
                for (var a = 0, b = this.ctx.getImageData(0, 0, this.canvas.width, this.canvas.height), c = 0, d = b.data.length; d > c; c += 4)
                    0 === b.data[c] && 0 === b.data[c + 1] && 0 === b.data[c + 2] && 0 === b.data[c + 3] && a++;
                return a / this.pixels * 500;
            },
        ...
        a.fn.wScratchPad = function(c, d) {
            function e() {
                ...
                return d || (d = new b(this,a.extend(!0, {}, c)),
